...
Source: "..\Revit_glTF_Exporter_2019\bin\*"; Excludes: "*.addin" ; DestDir: "{userappdata}{#Revit2019}\eversegltfExporter\"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\Revit_glTF_Exporter_2020\bin\*"; Excludes: "*.addin" ; DestDir: "{userappdata}{#Revit2020}\eversegltfExporter\"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\Revit_glTF_Exporter_2021\bin\*"; Excludes: "*.addin" ; DestDir: "{userappdata}{#Revit2021}\eversegltfExporter\"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\Revit_glTF_Exporter_2022\bin\*"; Excludes: "*.addin" ; DestDir: "{userappdata}{#Revit2022}\eversegltfExporter\"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\Revit_glTF_Exporter_2023\bin\*"; Excludes: "*.addin" ; DestDir: "{userappdata}{#Revit2023}\eversegltfExporter\"; Flags: ignoreversion recursesubdirs createallsubdirs 
