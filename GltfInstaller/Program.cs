                                  ...
                                  new WixSharp.File(@"..\Common_glTF_Exporter\PackageContents.xml"),
                                      new Dir(@"Contents",
                                       new Dir(@"2019",
                                        ...
                                        new Dir(@"2025",
                                            new File(@"..\Common_glTF_Exporter\Leia_glTF_Exporter.addin"),
                                            new File(@"..\Revit_glTF_Exporter_2025\bin\Release\Leia_glTF_Exporter.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                            new File(@"..\Revit_glTF_Exporter_2025\bin\Release\DracoWrapper.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                            new File(@"..\Revit_glTF_Exporter_2025\bin\Release\MeshOpt.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                            ...
                                            new File(@"..\Revit_glTF_Exporter_2025\bin\Release\Leia_glTF_Exporter.deps.json",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                            new Files(@"..\Revit_glTF_Exporter_2025\bin\Release\*.png")),
                                        new Dir(@"2026",
                                            new File(@"..\Common_glTF_Exporter\Leia_glTF_Exporter.addin"),
                                            new File(@"..\Revit_glTF_Exporter_2026\bin\Release\Leia_glTF_Exporter.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                            new File(@"..\Revit_glTF_Exporter_2026\bin\Release\DracoWrapper.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                            new File(@"..\Revit_glTF_Exporter_2026\bin\Release\MeshOpt.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
